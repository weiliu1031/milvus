...
require (
	...
	github.com/zilliztech/woodpecker v0.1.9
...
replace github.com/milvus-io/milvus-proto/go-api/v2 => github.com/weiliu1031/milvus-proto/go-api/v2 v2.0.0-20251028072837-cf0beb3f10cf
