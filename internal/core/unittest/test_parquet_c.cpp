...
//     auto payload = NewPayloadWriter(int(milvus::DataType::BOOL), false);
//     bool data[] = {true, false, true, false};

//     uint8_t* valid_data = new uint8_t[5]{0x01, 0x01, 0x01, 0x01, 0x01};

//     auto st = AddBooleanToPayload(payload, data, valid_data, 4);
