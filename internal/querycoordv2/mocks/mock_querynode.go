...
// WatchDeltaChannels provides a mock function with given fields: _a0, _a1
func (_m *MockQueryNodeServer) WatchDeltaChannels(_a0 context.Context, _a1 *querypb.WatchDeltaChannelsRequest) (*commonpb.Status, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *commonpb.Status
	if rf, ok := ret.Get(0).(func(context.Context, *querypb.WatchDeltaChannelsRequest) *commonpb.Status); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*commonpb.Status)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *querypb.WatchDeltaChannelsRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
// MockQueryNodeServer_WatchDeltaChannels_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'WatchDeltaChannels'
type MockQueryNodeServer_WatchDeltaChannels_Call struct {
	*mock.Call
}

// WatchDeltaChannels is a helper method to define mock.On call
//  - _a0 context.Context
//  - _a1 *querypb.WatchDeltaChannelsRequest
func (_e *MockQueryNodeServer_Expecter) WatchDeltaChannels(_a0 interface{}, _a1 interface{}) *MockQueryNodeServer_WatchDeltaChannels_Call {
	return &MockQueryNodeServer_WatchDeltaChannels_Call{Call: _e.mock.On("WatchDeltaChannels", _a0, _a1)}
}

func (_c *MockQueryNodeServer_WatchDeltaChannels_Call) Run(run func(_a0 context.Context, _a1 *querypb.WatchDeltaChannelsRequest)) *MockQueryNodeServer_WatchDeltaChannels_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*querypb.WatchDeltaChannelsRequest))
	})
	return _c
}

func (_c *MockQueryNodeServer_WatchDeltaChannels_Call) Return(_a0 *commonpb.Status, _a1 error) *MockQueryNodeServer_WatchDeltaChannels_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
