...
func AssignReplica(m *meta.Meta, resourceGroups []string, replicaNumber int32) (map[string]int, error) {
...
func ReassignReplicaToRG(
	...
	newAssignment, err := AssignReplica(m, newResourceGroups, newReplicaNumber)
	if err != nil {
