...
func (_m *MockMixCoordClient) RestoreSnapshot(ctx context.Context, in *datapb.RestoreSnapshotRequest, opts ...grpc.CallOption) (*commonpb.Status, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_c *MockMixCoordClient_RestoreSnapshot_Call) Return(_a0 *commonpb.Status, _a1 error) *MockMixCoordClient_RestoreSnapshot_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockMixCoordClient_RestoreSnapshot_Call) RunAndReturn(run func(context.Context, *datapb.RestoreSnapshotRequest, ...grpc.CallOption) (*commonpb.Status, error)) *MockMixCoordClient_RestoreSnapshot_Call {
	_c.Call.Return(run)
	return _c
}
