...
type MockGrpcClient[T grpcclient.ComponentWithStates] struct {
	mock.Mock
}

type MockGrpcClient_Expecter[T grpcclient.ComponentWithStates] struct {
	mock *mock.Mock
}
...
type MockGrpcClient_Call_Call[T grpcclient.ComponentWithStates] struct {
	*mock.Call
}
...
type MockGrpcClient_Close_Call[T grpcclient.ComponentWithStates] struct {
	*mock.Call
}
...
type MockGrpcClient_EnableEncryption_Call[T grpcclient.ComponentWithStates] struct {
	*mock.Call
}
...
func (_m *MockGrpcClient[T]) GetGrpcClient(ctx context.Context) (T, error) {
	ret := _m.Called(ctx)
...
// MockGrpcClient_GetGrpcClient_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetGrpcClient'
type MockGrpcClient_GetGrpcClient_Call[T grpcclient.ComponentWithStates] struct {
	*mock.Call
}

// GetGrpcClient is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockGrpcClient_Expecter[T]) GetGrpcClient(ctx interface{}) *MockGrpcClient_GetGrpcClient_Call[T] {
	return &MockGrpcClient_GetGrpcClient_Call[T]{Call: _e.mock.On("GetGrpcClient", ctx)}
}

func (_c *MockGrpcClient_GetGrpcClient_Call[T]) Run(run func(ctx context.Context)) *MockGrpcClient_GetGrpcClient_Call[T] {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockGrpcClient_GetGrpcClient_Call[T]) Return(_a0 T, _a1 error) *MockGrpcClient_GetGrpcClient_Call[T] {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockGrpcClient_GetGrpcClient_Call[T]) RunAndReturn(run func(context.Context) (T, error)) *MockGrpcClient_GetGrpcClient_Call[T] {
	_c.Call.Return(run)
	return _c
}
...
type MockGrpcClient_GetNodeID_Call[T grpcclient.ComponentWithStates] struct {
	*mock.Call
}
...
type MockGrpcClient_GetRole_Call[T grpcclient.ComponentWithStates] struct {
	*mock.Call
}
...
type MockGrpcClient_ReCall_Call[T grpcclient.ComponentWithStates] struct {
	*mock.Call
}
...
type MockGrpcClient_SetGetAddrFunc_Call[T grpcclient.ComponentWithStates] struct {
	*mock.Call
}
...
type MockGrpcClient_SetNewGrpcClientFunc_Call[T grpcclient.ComponentWithStates] struct {
	*mock.Call
}
...
type MockGrpcClient_SetNodeID_Call[T grpcclient.ComponentWithStates] struct {
	*mock.Call
}
...
type MockGrpcClient_SetRole_Call[T grpcclient.ComponentWithStates] struct {
	*mock.Call
}
...
type MockGrpcClient_SetSession_Call[T grpcclient.ComponentWithStates] struct {
	*mock.Call
}
...
func NewMockGrpcClient[T grpcclient.ComponentWithStates](t interface {
	mock.TestingT
	Cleanup(func())
}) *MockGrpcClient[T] {
